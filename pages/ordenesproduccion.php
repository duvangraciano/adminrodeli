...
if (isset($pu['ver_ordenes_produccion'])) {
  
$ordenesProduccion = $misc->listarOrdenesProduccion()->fetchAll(PDO::FETCH_ASSOC);
...
?>
    ...
    <div class="row">
      <div class="col-md-12 col-sm-4 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Ordenes de producción <small>Sessions</small></h2>
                  ...
                  <table id="tablaordenesproduccion" class="table table-striped table-bordered bulk_action">
                    ...
                    <tbody id="tbody">
                      <?php  
                        ...
                        foreach ($ordenesProduccion as $value) {
                          echo '
                                  <tr class="even pointer">
                                    <td class="a-center "><input type="checkbox" class="flat" name="table_records"></td>
                                    <td>'.str_pad($value['oid'], 9,0,STR_PAD_LEFT).'</td>
                                    <td>'.$value['ord_prov_identificacion'].'</td>
                                    <td>'.$value['ord_responsable'].'</td>
                                    <td style="text-align: center;"><span class="label label-success">Confirmado</span>'.$value['ord_estado'].'</td>
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      $("div.toolbar").html('<button onclick="anularitem()" type="button" class="btn btn-warning"><i class="fa fa-ban"></i> Anular</button> <button onclick="confirmaritem()" type="button" class="btn btn-success"><i class="fa fa-check-circle"></i> Confirmar</button>');
