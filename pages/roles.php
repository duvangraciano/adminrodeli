...
?>
    ...
    <div class="row">
      <div class="col-md-12 col-sm-4 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Roles <small>Vista previa</small></h2>
            <a href="?mod=sistema&sub=nuevorol" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Nuevo</a> 
                        ...
                        foreach ($_rol as $value) {
                          echo '
                                  <tr class="even pointer">
                                    ...
                                    <td>'.true.'</td>
                                    <td><a href="?mod=sistema&sub=nuevorol&id='.$value['oid'].'" class="btn btn-info btn-xs">Editar</a></td>
                                  </tr>
                          ';
                        }
                      ?>
