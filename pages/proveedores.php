...
if (isset($pu['ver_proveedores'])) {


$get_all = $misc->get_all('tbl_proveedores',null,'prov_esproveedor','1');
$proveedores = ( $get_all['bool'] ? $get_all['data'] : array() );
...
?>
    ...
    <div class="row">
      <div class="col-md-12 col-sm-4 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Proveedores <small>Vista previa</small></h2>
            <a href="?mod=produccion&sub=tercero" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Nuevo</a> 
